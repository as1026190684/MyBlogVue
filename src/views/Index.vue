<template>
  <div v-title data-title="YTTE" >
    <el-container>
      <div class="indexBack"></div>
...
<!--        <a-player :music="videoUpload.music"></a-player>-->
<!--      </div>-->
<!--      <a-player :audio="audio" :lrcType="1" fixed />-->
<!--      <iframe frameborder="no" border="0" marginwidth="0" marginheight="0" width=330 height=450 src="http://localhost:8889/hosp?type=0&id=2054536487&auto=0&height=430"></iframe>-->
    </el-container>
  </div>
</template>
